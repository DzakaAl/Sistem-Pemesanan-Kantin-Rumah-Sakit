...
void tambahkanPesananDLL(Pesanan*& daftarpesanan, string namaMenu, int jumlahPorsi, double totalHarga) {
  ...
  if (daftarpesanan == nullptr) {
      ...
      pesananBaru->prev = temp;
  }
}

double tampilkanNotaBelanjaDLL(Pesanan*& daftarpesanan) {
  if (daftarpesanan == nullptr) {
...
void ubahDaftarPesananKePesananDLL(Pesanan*& daftarpesanan, Queue &antrianPesanan, PriorityQueue &antrianPesananPriority, bstree &avl, bool anggota, nodeptr &root, string namaFile3, string namaFile5, struk& pesanan) {
  if (daftarpesanan == nullptr) {
    cout << "Belum ada pesanan yang ditempatkan." << endl;
  }
  ...
  if (anggota == true){
    ...
    else
    {
        ...
        anggota = false;
        ubahDaftarPesananKePesananDLL(daftarpesanan, antrianPesanan, antrianPesananPriority, avl, anggota, root, namaFile3, namaFile5, pesanan);
    }
...
void hapusPesananDenganNomorDLL(Pesanan*& daftarpesanan, int nomorPesanan) {
  if (daftarpesanan == nullptr) {
...
void hapusSemuaDaftarPesananDLL(Pesanan*& daftarpesanan) {
