...
private:
  ...
  string namaFile1 = "Stock/menuMakananPecelLele.txt";
  string namaFile2 = "Stock/menuMinumanPecelLele.txt";
  string namaFile3 = "antrian/PecelLele.txt";
  string namaFile4 = "ulasan/ulasanPecelLele.txt";
  string namaFile5 = "antrianMember/antrianMembershipPecelLele.txt";
  string namaFile6 = "history/riwayatTransaksiPecelLele.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  PecelLele() : Makanan(0), Minuman(0) {
...
friend void tambahkanPesananDLL(Pesanan *&daftarpesanan, string namaMenu,
                                int jumlahPorsi, double totalHarga);
friend double tampilkanNotaBelanjaDLL(Pesanan *&daftarpesanan);
friend void pesanDLL(int &pesanan, Array1Ddinamis<Menu> &Menu, Pesanan *&daftarpesanan, string &namaFile);
friend void ubahDaftarPesananKePesananDLL(Pesanan *&daftarpesanan, Queue &antrianPesanan, PriorityQueue &antrianPesananPrioritas,bstree &avl, bool membership, nodeptr &root, string namaFile3, string namaFile5, struk &pesanan);
friend void hapusPesananDenganNomorDLL(Pesanan *&daftarpesanan,
                                       int nomorpesanan);
friend void hapusSemuaDaftarPesananDLL(Pesanan *&daftarpesanan);
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Pecel Lele Neng Shani:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Pecel Lele Neng Shani:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Pecel Lele Neng Shani:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Pecel Lele Neng Shani:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Pecel Lele Neng Shani:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Pecel Lele Neng Shani:"
                 << endl;
        ...
        pesanDLL(pesanan, Makanan, daftarpesanan, namaFile1);
      ...
      case 2: {
          cout << "Menu Minuman Pecel Lele Neng Shani:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Pecel Lele Neng Shani:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Pecel Lele Neng Shani:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Pecel Lele Neng Shani:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Pecel Lele Neng Shani"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Pecel Lele Neng Shani:"
                   << endl;
          ...
          pesanDLL(pesanan, Minuman, daftarpesanan, namaFile2);
...
void daftarPesanan(bstree &avl, nodeptr &root){
  if (daftarpesanan != nullptr) {
    tampilkanNotaBelanjaDLL(daftarpesanan); // Menampilkan nota belanja
    ...
    if (hapusPesanan) {
      ...
      hapusPesananDenganNomorDLL(daftarpesanan, nomorPesananHapus);
      ...
      if (pesanLagi) {
        ...
        tampilkanNotaBelanjaDLL(daftarpesanan);
      }
    } else {
      bool pesanLagi;
      cout << "Apakah Anda ingin memesan lagi (1 = ya, 0 = tidak)? ";
      ...
      if (pesanLagi) {
        ...
        cout << "Apakah anda mempunyai membership? (1 = yes || 0 = "
                "no) : ";
        cin >> membership;
        ubahDaftarPesananKePesananDLL(daftarpesanan, antrianPesanan, antrianPesananPrioritas, avl, membership, root, namaFile3, namaFile5, pesanan);
        double totalHargaNota = tampilkanNotaBelanjaDLL(daftarpesanan);
