...
private:
  ...
  string namaFile1 = "Stock/menuMakananSteak.txt";
  string namaFile2 = "Stock/menuMinumanSteak.txt";
  string namaFile3 = "antrian/antrianSteak.txt";
  string namaFile4 = "ulasan/ulasanSteak.txt";
  string namaFile5 = "antrianMember/antrianMembershipSteak.txt";
  string namaFile6 = "history/riwayatTransaksiSteak.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  Steak() : Makanan(0), Minuman(0) {
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Steak The Dims:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Steak The Dims:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Steak The Dims:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Steak The Dims:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Steak The Dims:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Steak The Dims:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Steak The Dims:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Steak The Dims:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Steak The Dims:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Steak The Dims:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Steak The Dims:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Steak The Dims:"
                   << endl;
...
void menuPenjual() {
  ...
  do {
    ...
    case 4: {
      cout << "Menu Minuman RM. Steak The Dims:" << endl;
