...
private:
  ...
  string namaFile1 = "Stock/menuMakananSoto.txt";
  string namaFile2 = "Stock/menuMinumanSoto.txt";
  string namaFile3 = "antrian/Soto.txt";
  string namaFile4 = "ulasan/ulasanSoto.txt";
  string namaFile5 = "antrianMember/antrianMembershipSoto.txt";
  string namaFile6 = "history/riwayatTransaksiSoto.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  Soto() : Makanan(0), Minuman(0) {
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Soto Nusantara:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Soto Nusantara" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Soto Nusantara:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Soto Nusantara:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Soto Nusantara" << endl;
            insertionSortByDescendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Soto Nusantara:" << endl;
      ...
      case 2: {
          cout << "Menu Minuman Soto Nusantara:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Soto Nusantara:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Soto Nusantara:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Soto Nusantara:" << endl;
              insertionSortByAscendingName(Minuman);
              displayMenuMinuman(Minuman);
              break;
            }
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Soto Nusantara:" << endl;
              insertionSortByDescendingName(Minuman);
              displayMenuMinuman(Minuman);
              break;
            }
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Soto Nusantara:" << endl;
