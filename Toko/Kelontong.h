...
private:
    ...
    string namaFile1 = "Stock/menuMakananKelontong.txt";
    string namaFile2 = "Stock/menuMinumanKelontong.txt";
    string namaFile3 = "antrian/antrianKelontong.txt";
    string namaFile4 = "ulasan/ulasanKelontong.txt";
    string namaFile5 = "antrianMember/antrianMembershipKelontong.txt";
    string namaFile6 = "history/riwayatTransaksiKelontong.txt";
    UlasanPembeli ulasanPembeli;
    struk pesanan;
    TransactionHistory history;

public:
    Kelontong() : Makanan(0), Minuman(0) {
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Warung Kelontong Ganjar:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Warung Kelontong Ganjar:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Warung Kelontong Ganjar:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Warung Kelontong Ganjar:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Warung Kelontong Ganjar:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Warung Kelontong Ganjar:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Warung Kelontong Ganjar:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Warung Kelontong Ganjar:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Warung Kelontong Ganjar:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Warung Kelontong Ganjar:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Warung Kelontong Ganjar:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Warung Kelontong Ganjar:"
                   << endl;
