...
private:
  ...
  string namaFile1 = "Stock/menuMakananWarmindo.txt";
  string namaFile2 = "Stock/menuMinumanWarmindo.txt";
  string namaFile3 = "antrian/antrianWarmindo.txt";
  string namaFile4 = "ulasan/ulasanWarmindo.txt";
  string namaFile5 = "antrianMember/antrianMembershipWarmindo.txt";
  string namaFile6 = "history/riwayatTransaksiWarmindo.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  Warmindo() : Makanan(0), Minuman(0) {
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Warmindo Gus Fikri:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Warmindo Gus Fikri:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Warmindo Gus Fikri:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Warmindo Gus Fikri:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Warmindo Gus Fikri:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Warmindo Gus Fikri:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Warmindo Gus Fikri:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Warmindo Gus Fikri:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Warmindo Gus Fikri:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Warmindo Gus Fikri:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Warmindo Gus Fikri:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Warmindo Gus Fikri:"
                   << endl;
