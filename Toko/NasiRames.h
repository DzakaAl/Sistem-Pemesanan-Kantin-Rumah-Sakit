...
private:
  ...
  string namaFile1 = "Stock/menuMakananNasiRames.txt";
  string namaFile2 = "Stock/menuMinumanNasiRames.txt";
  string namaFile3 = "antrian/antrianNasiRames.txt";
  string namaFile4 = "ulasan/ulasanNasiRames.txt";
  string namaFile5 = "antrianMember/antrianMembershipNasiRames.txt";
  string namaFile6 = "history/riwayatTransaksiNasiRames.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  NasiRames() : Makanan(0), Minuman(0) {
...
friend void ubahDaftarPesananKePesanaDLL(Pesanan *&daftarpesanan, Queue &antrianPesanan, PriorityQueue &antrianPesananPrioritas,bstree &avl, bool membership, nodeptr &root, string namaFile3, string namaFile5, struk &pesanan);
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Warung Nasi Rames BU GM:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Warung Nasi Rames BU GM:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Warung Nasi Rames BU GM:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Warung Nasi Rames BU GM:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Warung Nasi Rames BU GM:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Warung Nasi Rames BU GM:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Warung Nasi Rames BU GM:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Warung Nasi Rames BU GM:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Warung Nasi Rames BU GM:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Warung Nasi Rames BU GM:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Warung Nasi Rames BU GM:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Warung Nasi Rames BU GM:"
                   << endl;
