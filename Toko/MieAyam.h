...
private:
  ...
  string namaFile1 = "Stock/menuMakananMieAyam.txt";
  string namaFile2 = "Stock/menuMinumanMieAyam.txt";
  string namaFile3 = "antrian/antrianMieAyam.txt";
  string namaFile4 = "ulasan/ulasanMieAyam.txt";
  string namaFile5 = "antrianMember/antrianMembershipMieAyam.txt";
  string namaFile6 = "history/riwayatTransaksiMieAyam.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  MieAyam() : Makanan(0), Minuman(0) {
  ...
  friend void pesan(int &pesanan, Array1Ddinamis<Menu> &Menu, Pesanan *&daftarpesanan, string &namaFile);
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Mie Ayam Palembang Afui:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Mie Ayam Palembang Afui:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Mie Ayam Palembang Afui:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Mie Ayam Palembang Afui:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Mie Ayam Palembang Afui:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Mie Ayam Palembang Afui:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Mie Ayam Palembang Afui:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Mie Ayam Palembang Afui:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Mie Ayam Palembang Afui:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Mie Ayam Palembang Afui:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Mie Ayam Palembang Afui:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Mie Ayam Palembang Afui:"
                   << endl;
