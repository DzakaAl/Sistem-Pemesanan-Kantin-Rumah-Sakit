...
private:
  ...
  string namaFile1 = "Stock/menuMakananBakmieJawa.txt";
  string namaFile2 = "Stock/menuMinumanBakmieJawa.txt";
  string namaFile3 = "antrian/antrianBakmieJawa.txt";
  string namaFile4 = "ulasan/ulasanBakmieJawa.txt";
  string namaFile5 = "antrianMember/antrianMembershipBakmieJawa.txt";
  string namaFile6 = "history/riwayatTransaksiBakmieJawa.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  Bakmiejawa() : Makanan(0), Minuman(0) {
...
void menuPembeli(bstree &avl, nodeptr &root) {
  ...
  do {
    ...
    case 1: {
      ...
      switch (pilCara) {
      case 1: {
        cout << "Menu Makanan Bakmie Jawa Bang Aqep:" << endl;
        cout << "0. Filter Menu\n";
        ...
        if (pesanan == 0) {
          ...
          case 2: {
            cout << "Menu Makanan Terlaris Bakmie Jawa Bang Aqep:" << endl;
            menuTerlaris(Makanan);
            break;
          }
          case 3: {
            cout << "Menu Makanan yang diskon Bakmie Jawa Bang Aqep:" << endl;
            menuDiskon(Makanan);
            break;
          }
          case 4: {
            cout << "Urutkan Nama Menu ⬆️ di Bakmie Jawa Bang Aqep:" << endl;
            insertionSortByAscendingName(Makanan);
            displayMenuMakanan(Makanan);
            break;
          }
          case 5: {
            cout << "Urutkan Nama Menu ️⬇️ di Bakmie Jawa Bang Aqep:"
                 << endl;
          ...
          case 6: {
            cout << "Urutkan Harga Menu ⬆️ di Bakmie Jawa Bang Aqep:"
                 << endl;
      ...
      case 2: {
          cout << "Menu Minuman Bakmie Jawa Bang Aqep:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan== 0) {
            ...
            case 2: {
              cout << "Menu Minuman Terlaris Bakmie Jawa Bang Aqep:" << endl;
              menuTerlaris(Minuman);
              break;
            }
            case 3: {
              cout << "Menu Minuman yang diskon Bakmie Jawa Bang Aqep:" << endl;
              menuDiskon(Minuman);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Minuman ⬆️ di Bakmie Jawa Bang Aqep:"
                   << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Minuman ️⬇️ di Bakmie Jawa Bang Aqep:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Minuman ⬆️ di Bakmie Jawa Bang Aqep:"
                   << endl;
