...
private:
  ...
  string namaFile1 = "Stock/menuMakananPadang.txt";
  string namaFile2 = "Stock/menuMinumanPadang.txt";
  string namaFile3 = "antrian/antrianPadang.txt";
  string namaFile4 = "ulasan/ulasanPadang.txt";
  string namaFile5 = "antrianMember/antrianMembershipPadang.txt";
  string namaFile6 = "history/riwayatTransaksiPadang.txt";
  UlasanPembeli ulasanPembeli;
  struk pesanan;
  TransactionHistory history;

public:
  Padang() : Makanan(0), Minuman(0) {
  ...
  void menuPembeli(bstree &avl, nodeptr &root) {
    ...
    do {
      ...
      case 1: {
        ...
        switch (pilCara) {
        case 1: {
          cout << "Menu Makanan RM. Padang Uda Adi:" << endl;
          cout << "0. Filter Menu\n";
          ...
          if (pesanan == 0) {
            ...
            case 2: {
              cout << "Menu Makanan Terlaris RM. Padang Uda Adi:" << endl;
              menuTerlaris(Makanan);
              break;
            }
            case 3: {
              cout << "Menu Makanan yang diskon RM. Padang Uda Adi:" << endl;
              menuDiskon(Makanan);
              break;
            }
            case 4: {
              cout << "Urutkan Nama Menu ⬆️ di RM. Padang Uda Adi:" << endl;
            ...
            case 5: {
              cout << "Urutkan Nama Menu ️⬇️ di RM. Padang Uda Adi:"
                   << endl;
            ...
            case 6: {
              cout << "Urutkan Harga Menu ⬆️ di RM. Padang Uda Adi:"
                   << endl;
        ...
        case 2: {
            cout << "Menu Minuman RM. Padang Uda Adi:" << endl;
            cout << "0. Filter Menu\n";
            ...
            if (pesanan== 0) {
              ...
              case 2: {
                cout << "Menu Minuman Terlaris RM. Padang Uda Adi:" << endl;
                menuTerlaris(Minuman);
                break;
              }
              case 3: {
                cout << "Menu Minuman yang diskon RM. Padang Uda Adi:" << endl;
                menuDiskon(Minuman);
                break;
              }
              case 4: {
                cout << "Urutkan Nama Minuman ⬆️ di RM. Padang Uda Adi:"
                     << endl;
              ...
              case 5: {
                cout << "Urutkan Nama Minuman ️⬇️ di RM. Padang Uda Adi:"
                     << endl;
              ...
              case 6: {
                cout << "Urutkan Harga Minuman ⬆️ di RM. Padang Uda Adi:"
                     << endl;
